...
public class TipoHabitacion {
    ...
    public String toString() {
        return "TipoHabitacionj{" + "idTipoHab=" + idTipoHab + ", codigo=" + codigo + ", cantPersonas=" + cantPersonas + ", cantCamas=" + cantCamas + ", categoriaCama=" + categoriaCama + ", tipoHabitacion=" + tipoHabitacion + ", precioNoche=" + precioNoche + '}';
    }
